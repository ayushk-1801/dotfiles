Config { font = "JetBrainsMono Nerd Font, Bold, 16"
    , bgColor = "#000000"
        ...
        , template = "%UnsafeStdinReader% }{ <fc=#16161D,#1ED55F>%music%</fc> <fc=#16161D,#E46876> VOL </fc><fc=#16161D,#D27E88> %default:Master% </fc> <fc=#16161D,#FF9E3B> CPU </fc><fc=#16161D,#DCA561> %cpu% </fc> <fc=#16161D,#957FB8> MEM </fc><fc=#16161D,#938AA9> %memory% </fc> <fc=#DCD7BA,#E82424> BAT </fc><fc=#DCD7BA,#C34043> %battery% </fc> <fc=#16161D,#658594> 󰥔 </fc><fc=#16161D,#7E9CD8> %date% </fc>"
}
